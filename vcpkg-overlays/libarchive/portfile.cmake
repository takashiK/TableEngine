...
vcpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DENABLE_EXPAT=OFF
        -DENABLE_LibGCC=OFF
        # TableEngine overlay override: enable Windows CNG (bcrypt) so the ZIP
        # writer can produce AES-256 encrypted archives. Upstream port sets this
        # to OFF, which disables ZIP write encryption.
        -DENABLE_CNG=ON
        -DENABLE_UNZIP=OFF
        -DENABLE_TAR=OFF
        -DENABLE_CPIO=OFF
