...
/**
 * @file TeCmdFolderCloseAll.cpp
 * @brief Implementation of TeCmdFolderCloseAll.
 * @ingroup commands
 */
...
bool TeCmdFolderCloseAll::isSelected(TeViewStore* p_store, const TeCmdParam* p_cmdParam)
{
	NOT_USED(p_store);
	return false;
}
