...
bool TeCmdCopy::isActive( TeViewStore* p_store )
{
	NOT_USED(p_store);
	return false;
}

bool TeCmdCopy::isSelected(TeViewStore* p_store, const TeCmdParam* p_cmdParam)
{
	NOT_USED(p_store);
	return false;
}

QFlags<TeTypes::CmdType> TeCmdCopy::type()
{
