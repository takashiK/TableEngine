...
QFlags<TeTypes::CmdType> TeCmdWindowCloseTab::type()
{
...
bool TeCmdWindowCloseTab::execute(TeViewStore* p_store)
{
	if (!p_store)
		return true;
	...
	if (!folderView)
		return true;
	p_store->deleteFolderView(folderView);
