...
#define SETTING( key, default_value)  settings.setValue( QKeySequence(key).toString().replace("+", "_") , settings.value( QKeySequence(key).toString().replace("+", "_") , default_value ))
	...
	SETTING(Qt::CTRL | Qt::Key_A, TeTypes::CMDID_SYSTEM_EDIT_SELECT_ALL);
	...
	SETTING(Qt::Key_F5, TeTypes::CMDID_SYSTEM_VIEW_REFRESH);
	...
	SETTING(Qt::Key_S, TeTypes::CMDID_SYSTEM_VIEW_SORT_SETTING);

	SETTING(Qt::Key_V, TeTypes::CMDID_SYSTEM_TOOL_VIEW_FILE);
	SETTING(Qt::Key_B, TeTypes::CMDID_SYSTEM_TOOL_VIEW_BINARY);
	SETTING(Qt::Key_E, TeTypes::CMDID_SYSTEM_TOOL_EDIT_FILE);
	SETTING(Qt::CTRL | Qt::Key_E, TeTypes::CMDID_SYSTEM_TOOL_EDIT_BINARY);
	...
	SETTING(Qt::CTRL | Qt::Key_D, TeTypes::CMDID_SYSTEM_WINDOW_DETAIL);
	SETTING(Qt::CTRL | Qt::Key_P, TeTypes::CMDID_SYSTEM_WINDOW_NAVIGATION);
